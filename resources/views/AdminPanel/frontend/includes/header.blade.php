...
<div class="app-header header sticky">
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <!-- sidebar-toggle-->
            <a class="logo-horizontal " href="{{route('adminDashboard')}}">
                <img src="{{asset('AdminAssets/images/brand/logo.png')}}" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{asset('AdminAssets/images/brand/logo-3.png')}}" class="header-brand-img light-logo1" alt="logo">
            </a>
            <!-- LOGO -->
                        ...
                        <div class="d-flex order-lg-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading border-bottom">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-auto">
                                                <span class="badge bg-danger-transparent header-badge text-danger fs-14">Hurry
                                                    Up!</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="header-dropdown-list message-menu">
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image" data-bs-image-src="{{asset('AdminAssets/images/pngs/4.jpg')}}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image" data-bs-image-src="{{asset('AdminAssets/images/pngs/6.jpg')}}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image" data-bs-image-src="{{asset('AdminAssets/images/pngs/8.jpg')}}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image" data-bs-image-src="{{asset('AdminAssets/images/pngs/1.jpg')}}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image" data-bs-image-src="{{asset('AdminAssets/images/pngs/3.jpg')}}"></span>
                                            <div class="wd-50p">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <div class="message-menu message-menu-scroll">
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('AdminAssets/images/users/1.jpg')}}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('AdminAssets/images/users/15.jpg')}}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('AdminAssets/images/users/12.jpg')}}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('AdminAssets/images/users/4.jpg')}}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('AdminAssets/images/users/3.jpg')}}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                    <img src="{{asset('AdminAssets/images/users/21.jpg')}}" alt="profile-user" class="avatar  profile-user brround cover-image">
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
