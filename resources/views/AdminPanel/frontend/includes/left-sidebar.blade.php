...
<div class="sticky">
    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{route('adminDashboard')}}">
                <img src="{{asset('AdminAssets/images/brand/logo.png')}}" class="header-brand-img desktop-logo " alt="logo">
                <img src="{{asset('AdminAssets/images/brand/logo-1.png')}}" class="header-brand-img toggle-logo " alt="logo">
                <img src="{{asset('AdminAssets/images/brand/logo-2.png')}}" class="header-brand-img light-logo " alt="logo">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('adminDashboard')}}"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Dashboard</span></a>
                </li>
                <!-- <li class="sub-category">
                    <h3>UI Kit</h3>
                </li> -->
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i class="side-menu__icon fa fa-users"></i><span class="side-menu__label">Collaborators</span><i class="angle fe fe-chevron-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Collaborators</a></li>
                        <li><a href="{{route('createCollaborator')}}" class="slide-item"> Create</a></li>
                        <li><a href="{{route('collaboratorsList')}}" class="slide-item"> List</a></li>
                ...
                <li>
                    <a class="side-menu__item has-link" href="landing-page.html" target="_blank"><i class="side-menu__icon fe fe-zap"></i><span class="side-menu__label">Landing
                    ...
                    <ul class="slide-menu">
                        ...
                        <li class="sub-slide">
                            ...
                            <ul class="sub-slide-menu">
                                ...
                                <li><a href="extension-tables.html" class="sub-slide-item"> Extension Tables</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-slide">
